...
public class HttpRequestCommon {
    public static String url ="http://xedike.ddnsking.com";
    ...
    public static String url_user_signup ="http://xedike.ddnsking.com/api/v1/users/signup";
    public static String url_intersection_id ="http://xedike.ddnsking.com/api/v1/intersections/id?id=";
}
